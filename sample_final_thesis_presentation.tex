...
\begin{itemize}
  \item The active box captures most low-frequency $\rho$ mass.
  \item The radial profile shows how quickly Fourier weights decay away from the origin.
  \item The cumulative curve makes the cutoff quality visible.
\end{itemize}
\end{block}
\end{columns}
\end{frame}
...
\begin{itemize}
  ...
  \item Normalized off-diagonal couplings quantify residual tail interactions.
